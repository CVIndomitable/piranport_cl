...
本文档按版本顺序列出每个 alpha 版的核心内容。已完成的详细 Phase 记录见 `phases_archive.md`，代码审查记录见 `code_review_*.md`。
...
| v0.0.12-alpha | Gastronomy | DONE | 按 7.1 食物表对齐：新创造栏"舰娘食物"；新增 5 种作物（扁豆/红豆/芹菜/黑麦 + 桃树+桃子自然生成） + ~20 种食材/调料/中间品 + ~10 道菜品；厨锅/砧板/石磨/工作台/烟熏/酿造 60+ 合成 |

---

## 参考

- 已完成 Phase 详情：`phases_archive.md`
- 代码审查归档：
  - `code_review_2026-03-31.md`
  - `code_review_2026-04-04.md`
  - `code_review_2026-04-05.md`
  - `code_review_2026-04-10.md`
  - `code_review_2026-04-17.md`
  - `code_review_missile_2026-04-18.md`
  - `code_review_kitchen_2026-04-18.md`
  - `code_review_workbench_2026-04-18.md`
  - `code_review_dungeon_2026-04-18.md`
