...
public class ModCommonConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue AUTO_RESUPPLY_ENABLED =
            BUILDER
                    .comment(
    ...
    public static final ForgeConfigSpec.BooleanValue FLAMMABLE_EFFECT_ENABLED =
            BUILDER
                    .comment(
    ...
    public static final ForgeConfigSpec.BooleanValue WEAPON_PICKUP_TO_INVENTORY =
            BUILDER
                    .comment(
    ...
    public static final ForgeConfigSpec.BooleanValue SALT_GENERATION_ENABLED =
            BUILDER
                    .comment(
    ...
    public static final ForgeConfigSpec.BooleanValue SLAV_PRISON_MODE =
            BUILDER
                    .comment(
    ...
    public static final ForgeConfigSpec.BooleanValue GIVE_GUIDEBOOK_ON_FIRST_JOIN =
            BUILDER
                    .comment(
