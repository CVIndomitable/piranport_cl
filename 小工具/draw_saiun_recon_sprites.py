...
SPINNER = (186, 190, 184, 255)    # BABEB8 桨毂锥
...
def draw_saiun(empty: bool):
    ...
    坐标构图（左上为原点，对应原画 ÷16）：
      垂尾顶 (6,8)   尾锥 (7,12)   机头/桨毂 (29,18)
      远翼（右上）翼尖 (30,10)，近翼（左下）翼尖 (3,23)
      座舱罩 (12,13)-(22,16) 长条温室
      发动机罩 (23,15)-(27,20)，桨叶黑片在其上下
    ...
    # ---- 8) 桨毂锥 + 上下两片黑色桨叶（原画的螺旋桨姿态）----
    poly(im, [(28, 16), (31, 19), (28, 22)], SPINNER)
    px(im, 30, 18, WHITE)
    # 上桨叶：从毂顶向上弯出翼展外，黑片压在远翼之上
    for bx, by in [(28, 14), (29, 13), (29, 12), (30, 11)]:
        px(im, bx, by, OUTLINE)
    px(im, 28, 13, OUTLINE)
    # 下桨叶：向左下垂到机腹外
    for bx, by in [(28, 23), (27, 24), (26, 24)]:
        px(im, bx, by, OUTLINE)
